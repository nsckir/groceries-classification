...
PRETRAINED_CHECKPOINT_DIR=${HOME}/PycharmProjects/scoodit_image_classification/models/inception_v3/scoodit_178/bt_32_cl_16_r_16_thr_64_lr1_0_lr2_0.0005/all
